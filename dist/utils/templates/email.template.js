...
exports.emailTemplates = {
    confirmEmail: ({ otp, firstName, link, }) => {
        return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="message">
                We received a request to verify your email address. To complete the verification process for ${env_1.APP_NAME}, please use either the One-Time Password (OTP) code below or click the verification button:
            </div>
